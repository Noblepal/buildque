					...
					<ul>
						...
						<li data-index="rs-129">
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									...
									<h2>Welcome to Construction <span>Services Company</span></h2>

									<p>
										We provide a platform for people to search for services within murang'a county from the comfort of their homes
									</p>
						...
						<li data-index="rs-130"   data-title="" data-description="">
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									<span>Search</span>
									<h2>Assuring you of Our Best <span>Services</span></h2>

									<p>
										It is now easier to find contractors offering various services within Murang'a county
									</p>
									<a class="btn-text" href="about_us.html"> read more</a>
								</div>
							</div>
						...
						<li data-index="rs-131">
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									<span>Simple</span>
									<h2>Easy And Reliable<span> Service Directory</span></h2>

									<p>
										Just Create an account and we give you a list of all available contractors within Murang'a county
									</p>
									<a class="btn-text" href="about_us.html"> read more</a>
								</div>
							</div>
						...
						<div id="team-carousel" class="owl-carousel team-carousel nf-carousel-theme">
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Joan Maina</span>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Joseph Ndung'u</span>
									<span class="postion">Engineer</span>
								</div>
							</div>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Jacinta Wanjiku</span>
									<span class="postion">Engineer</span>
								</div>
							</div>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Dennis Likomba</span>
									<span class="postion">Engineer</span>
								</div>
							</div>
